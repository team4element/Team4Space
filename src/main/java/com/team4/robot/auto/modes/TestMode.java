...
import com.team4.robot.auto.actions.DriveTrajectory;
...
public class TestMode extends AutoModeBase {
    ...
    protected void routine() throws AutoModeEndedException {
        ...
        runAction(new DriveTrajectory(TrajectoryGenerator.getInstance().getTrajectorySet().sideStartToNearScale.get(true), true));
