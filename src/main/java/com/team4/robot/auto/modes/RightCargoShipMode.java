...
import com.team4.robot.auto.paths.right.BallFeederToCargoShip1Path;
import com.team4.robot.auto.paths.right.CargoShip2ToBallFeederPath;
import com.team4.robot.auto.paths.right.Hab2ToCargoShip2Path;
import com.team4.robot.constants.ArmConstants;

public class RightCargoShipMode extends AutoModeBase{
    boolean mIsHab2;

    public RightCargoShipMode(boolean isHab2){
        mIsHab2 = isHab2;
    }
