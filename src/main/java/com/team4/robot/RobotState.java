...
import com.team4.lib.drivers.VisionSubsystem;
...
public class RobotState {
    ...
    private Translation2d getCameraToVisionTargetPose(TargetInfo target, boolean high, VisionSubsystem source) {
        ...
        double differential_height = source.getLensHeight() - (high ? TargetingConstants.kPortTargetHeight : TargetingConstants.kHatchTargetHeight);
    ...
    private void updatePortGoalTracker(double timestamp, List<Translation2d> cameraToVisionTargetPoses, GoalTracker tracker, VisionSubsystem source) {
    ...
    public synchronized void addVisionUpdate(double timestamp, List<TargetInfo> observations, VisionSubsystem source) {
    ...
    public synchronized Optional<AimingParameters> getAimingParameters(boolean highTarget, int prev_track_id, double max_track_age) {
        ...
        TrackReportComparator comparator = new TrackReportComparator(
                TargetingConstants.kTrackStabilityWeight,
                TargetingConstants.kTrackAgeWeight,
                TargetingConstants.kTrackSwitchingWeight,
