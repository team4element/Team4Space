...
public class Kinematics {
    ...
    public static Twist2d forwardKinematics(double left_wheel_delta, double right_wheel_delta) {
        double delta_rotation = (right_wheel_delta - left_wheel_delta) / (PhysicalConstants.kDriveWheelTrackWidthInches * PhysicalConstants.kTrackScrubFactor);
    ...
    public static DriveSignal inverseKinematics(Twist2d velocity) {
        ...
        double delta_v = PhysicalConstants.kDriveWheelTrackWidthInches * velocity.dtheta / (2 * PhysicalConstants.kTrackScrubFactor);
