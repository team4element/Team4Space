...
public class Kinematics {
    ...
    public static Twist2d forwardKinematics(double left_wheel_delta, double right_wheel_delta) {
        double delta_rotation = (right_wheel_delta - left_wheel_delta) / (DriveConstants.kDriveWheelTrackWidthInches * DriveConstants.kTrackScrubFactor);
    ...
    public static DriveVelocity inverseKinematics(Twist2d velocity) {
        ...
        double delta_v = DriveConstants.kDriveWheelTrackWidthInches * velocity.dtheta / (2 * DriveConstants.kTrackScrubFactor);
