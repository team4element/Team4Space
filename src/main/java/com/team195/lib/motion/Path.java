...
public class Path {
    ...
    public void checkSegmentDone(Translation2d robotPos) {
        ...
        if (remainingDist < PathFollowingConstants.kSegmentCompletionTolerance) {
    ...
    public void verifySpeeds() {
        ...
        for (int i = segments.size() - 1; i >= 0; i--) {
            ...
            maxStartSpeed += Math
                    .sqrt(maxStartSpeed * maxStartSpeed + 2 * PathFollowingConstants.kPathFollowingMaxAccel * segment.getLength());
