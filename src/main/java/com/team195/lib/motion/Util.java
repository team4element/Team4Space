package com.team195.lib.motion;
...
public class Util {
    ...
    public static int convertRPMToNativeUnits(double rpm) {
        return (int)(rpm * DriveConstants.kSensorUnitsPerRotation / Constants.k100msPerMinute);
    }

    public static int convertNativeUnitsToRPM(double nativeUnits) {
        return (int)(nativeUnits / DriveConstants.kSensorUnitsPerRotation * Constants.k100msPerMinute);
    }
