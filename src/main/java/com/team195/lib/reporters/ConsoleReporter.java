package com.team195.lib.reporters;
...
/**
 * A class to report messages to the console or DriverStation. Messages with a
 * level of DEFCON1 will always be reported whether reporting is enabled or not
 * and will be reported both to the console and the DriverStation.
 */
