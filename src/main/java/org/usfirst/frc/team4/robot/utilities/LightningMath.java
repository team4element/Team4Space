...
public class LightningMath {
    ...
    public static double inches2ticks(double inches) {
        return inches / ChassisConstants.circumference * ChassisConstants.ticksPerRevolution;
    }

    public static double ticks2inches(double ticks) {
        return ticks / ChassisConstants.ticksPerRevolution * ChassisConstants.circumference;
    }
